...
pub use options::{
    BG_CMD_PLACEHOLDER, PANE_AGENT, PANE_ATTENTION, PANE_BG_CMD, PANE_CWD,
    ...
    PANE_WORKTREE_NAME, get_all_global_options, get_option, get_pane_option_value, set_pane_option,
    unset_pane_option,
};
pub use panes::{
